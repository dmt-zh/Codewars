...
# Examples: Call fcn the function such as fcn(n) = un.
...
# the second one - not at all mandatory, but as a complement - is to get a
# bit your head around and find which sequence is hidden behind un.
